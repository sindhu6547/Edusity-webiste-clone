  ...
  return (
    <div className='about'>
      <div className="about-left">
        <img src='https://greatstack.in/assets/about-Bupj5-5F.png' alt='logo-icon' className='logo left-img'></img>
        <img src='https://greatstack.in/assets/play-icon-DiRyRcRm.png' alt='play-icon' className='play-icon left-img'></img>
      </div>
